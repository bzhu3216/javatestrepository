...
<script type="text/javascript">
	function checkForm() {
		...
		if (oldPassword != '${currentUser.pwd}') {
			alert("原密码错误，请重新输入");
			return false;
		}
...
<p style="font-size: 30px;">修改个人密码</p>
...
<form action="user!updatePassword" method="post"
	...
	<table width="40%" align="center">
		<tr>
			<td><label>用户名：</td>
			<td><input type="text" value="${currentUser.id }" name="user.id"
		...
		<tr>
			<td><label>新密码：</td>
			<td><input type="password" id="newPassword1" name="user.pwd" /></td>
		</tr>
		<tr>
			<td><label>确认新密码：</td>
