...
<table width="90%" align="center">
	<tr>
		...
		<td><input type="text" id="subject" value="${question.subject }"
	...
	<tr>
		...
		<td><input type="text" id="paperName" readonly="readonly"
			value="${question.paper.paperName }" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" id="optionA" readonly="readonly"
			value="${question.optionA }" /></td>
	</tr>
	<tr>
		<td><label>选项二：</label></td>
		<td><input type="text" id="optionB" readonly="readonly"
			value="${question.optionB }" /></td>
	</tr>
	<tr>
		<td><label>选项三：</label></td>
		<td><input type="text" id="optionC" readonly="readonly"
			value="${question.optionC }" /></td>
	</tr>
	<tr>
		<td><label>选项四：</label></td>
		<td><input type="text" id="optionD" readonly="readonly"
	...
	<tr>
		...
		<td><input type="text" id="level" readonly="readonly"
			value="${question.level }" /></td>
	</tr>
	<tr>
		<td colspan="2">
